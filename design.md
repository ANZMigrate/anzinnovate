# ANZInnovate design system

## Direction

A systems-led, grid-forward art direction. It uses a cooler palette, sharper geometry and less shadow to distinguish the umbrella site from the country satellites.

## Audience and tone

The primary audience is International skilled professionals, employer sponsored workers and students. The voice is precise, calm and document-led. Explain the evidence and sequence rather than promising an outcome. Avoid vague conversion language and avoid claims that a visitor qualifies.
...
Acid lime accent on cool green-grey surfaces, with smaller radii and flatter cards.
